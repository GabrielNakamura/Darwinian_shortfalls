...
- Metrics 
    ...
    - [X] Possibility to use data from FB
    
- Possible improvements
    - [ ] Use the availability of molecular data check [Rentrez package](https://cran.r-project.org/web/packages/rentrez/vignettes/rentrez_tutorial.html) and [Rudbeck et al paper](https://onlinelibrary.wiley.com/doi/full/10.1111/ecog.06142)
    - [ ] Project Darwinian shortfall in space using meaningful scale (watershed for freshwater and realms for marine?)
