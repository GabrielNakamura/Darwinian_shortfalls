...
data <- read.table(here("data", "taxa_table.txt"), header = TRUE) # all valid fish species from fishbase
data_insertion <- data # data frame that will receive insertion information
